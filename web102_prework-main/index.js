...
console.log('Loaded games:', GAMES_JSON.length);
/*************************************************************************************
...
const totalContributions = GAMES_JSON.reduce((sum, game) => sum + Number(game.backers || 0), 0);
...
const totalRaised = GAMES_JSON.reduce((sum, game) => sum + Number(game.pledged || 0), 0);
...
const gameWord = totalGames === 1 ? 'game' : 'games';
const remainPhrase = unfundedCount === 1 ? 'game remains' : 'games remain';

const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for 
${totalGames.toLocaleString()} ${gameWord}. Currently, ${unfundedCount.toLocaleString()} 
${remainPhrase} unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const summaryP = document.createElement('p');
summaryP.textContent = displayStr;
